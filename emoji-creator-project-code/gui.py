...
def show_vid():      
    ...
    bounding_box = cv2.CascadeClassifier('D:/Users/Jayesh/AppData/Local/Programs/Python/Python311/Lib/site-packages/cv2/data/haarcascade_frontalface_default.xml')
